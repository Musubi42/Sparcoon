            ...
            <form action="{{ route('objectEstates.store') }}" method="post">
                <div
                    ...
                    <div class="w-full md:w-auto mb-6 md:mb-0 md:pr-6">
                        <div
                            ...
                            <svg xwidth="21" height="21" mlns="http://www.w3.org/2000/svg" fill="white"
                                viewBox="0 0 448 512">
                    ...
                    <div class="w-full md:flex-1 md:pt-3">
                        <h3 class="mb-4 text-xl md:text-2xl leading-tight text-coolGray-900 font-bold">Nom du soignant</h3>
                        ...
                        <input name="name"
                            ...
                            type="text" placeholder="Nom de l'intervenant" required>
                    </div>
                </div>
                <input type="hidden" name="patrimoine_id" value="">
                <div
                    class="flex flex-wrap p-8 text-center md:text-left hover:bg-white rounded-md hover:shadow-xl transition duration-200">
                    <div class="w-full md:w-auto mb-6 md:mb-0 md:pr-6">
                        <div
                    ...
                    <div class="w-full md:flex-1 md:pt-3">
                        <h3 class="mb-4 text-xl md:text-2xl leading-tight text-coolGray-900 font-bold">Prénom du soignant
                        </h3>
                        <label class="block mb-2 text-xs text-gray-700 uppercase tracking-wide font-bold"></label>
                        <input name="name"
                            class="appearance-none block w-full py-3 px-4 mb-2 md:mb-0 leading-tight text-gray-700 bg-gray-200 focus:bg-white border border-gray-200 focus:border-gray-500 rounded focus:outline-none"
                            type="text" placeholder="Prénom de l'intervenant" required>
                    </div>
                </div>
                ...
                <div
                    ...
                    <div class="w-full md:w-auto mb-6 md:mb-0 md:pr-6">
                        <div
                            class="inline-flex h-14 w-14 mx-auto items-center justify-center text-white bg-green-700 rounded-lg">
                            <svg width="21" height="21" viewBox="0 0 448 512" fill="white"
                    ...
                    <div class="w-full md:flex-1 md:pt-3">
                        <h3 class="mb-4 text-xl md:text-2xl leading-tight text-coolGray-900 font-bold">Téléphone</h3>
                        <input
                            class="appearance-none block w-full py-3 px-4 mb-2 md:mb-0 leading-tight text-gray-700 bg-gray-200 focus:bg-white border border-gray-200 focus:border-gray-500 rounded focus:outline-none"
                            type="tel" id="phone" name="phone" placeholder="06.00.00.00.00"
                ...
                <div
                    ...
                    <div class="w-full md:w-auto mb-6 md:mb-0 md:pr-6">
                        <div
                            class="inline-flex h-14 w-14 mx-auto items-center justify-center text-white bg-green-700 rounded-lg">
                            <svg width="21" height="21" viewBox="0 0 384 512" fill="white"
                                xmlns="http://www.w3.org/2000/svg">
                                <path
                    ...
                    <div class="w-full md:flex-1 md:pt-3">
                        <h3 class="mb-4 text-xl md:text-2xl leading-tight text-coolGray-900 font-bold">Mail</h3>
                        <label class="block mb-2 text-xs text-gray-700 uppercase tracking-wide font-bold"></label>
                        <input name="value"
                            class="appearance-none block w-full py-3 px-4 mb-2 md:mb-0 leading-tight text-gray-700 bg-gray-200 focus:bg-white border border-gray-200 focus:border-gray-500 rounded focus:outline-none"
                            type="email" id="email" placeholder="john.doe@gmail.com" required>
                    </div>
                </div>
                ...
                <div
                    ...
                    <div class="w-full md:flex-1 md:pt-3">
                        ...
                        <label class="block mb-2 text-xs text-gray-700 uppercase tracking-wide font-bold"></label>
                        <textarea name="description" class="appearance-none block w-full py-3 px-4 leading-tight text-gray-700 bg-gray-200 focus:bg-white border border-gray-200 focus:border-gray-500 rounded focus:outline-none"
                            placeholder="Description de l'intervenant" rows="5"></textarea>
                    </div>
                </div>
            </form>
            <div class="my-12"></div>
                ...
                <div class="flex justify-end">
                    <button type="submit">
                        <div
                            ...
                            <span class="whitespace-nowrap font-semibold text-2xl">Ajouter un intervenant</span>
                        </div>
                    </button>
                </div>
            </section>
                    ...
                    <div class="relative p-4 w-full max-w-2xl h-full md:h-auto">
                        ...
                        <div class="relative max-w-4xl p-6 sm:p-10 mx-auto bg-white rounded-lg shadow dark:bg-gray-700">
                            <form action="">
                                ...
                                <div class="mb-8">
                                    <label class="block mb-2 text-coolGray-800 font-medium leading-6" for="">Faites
                                        glisser
                                        la
                                        photo</label>
                                    <div
