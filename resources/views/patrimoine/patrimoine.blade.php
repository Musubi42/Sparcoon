...
@section('content')
    ...
    <table class="border-collapse table-auto w-full text-sm">
        ...
        <tbody class="bg-white">
            <tr class="">
                <td class="w-1/6 p-2"><img src="{{ asset('storage/asset/image/office.jpg') }}" alt=""
                        class="rounded shadow-md" title="" style=""></td>
                ...
                <td class="border-b p-2 text-center"><span class="flex justify-center"><button class="p-2"
                            type="button" data-modal-toggle="modal-delete"><svg xmlns="http://www.w3.org/2000/svg"
                                viewBox="0 0 576 512" class="w-10 flex align-middle items-center">
                                <path
