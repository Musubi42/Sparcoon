...
@section('content')
    {{-- Faudrait afficher objet créé si le submit du form fonctionne bien --}}
                    ...
                    <div class="flex flex-row">
                        <div class="w-full md:w-1/2 lg:w-1/3 px-4 mb-12">
                            <div class="max-w-max mx-auto">
                                ...
                                <span class="text-lg font-medium text-gray-500 line-clamp-2">CEO &amp; Founder CEO &amp;
                                    Founder
                                    CEO
                                    &amp; FounderCEO &amp; Founder CEO &amp; Founder CEO &amp; CEO &amp; Founder Founder
                                </span>
                            </div>
                        </div>
                        ...
                        <div class="w-full md:w-1/2 lg:w-1/3 px-4 mb-12">
                            <div class="max-w-max mx-auto">
                                <h4 class="mb-2 text-3xl md:text-4xl leading-tight font-semibold">Macauley Herring</h4>
                                <img class="block mb-8" src="flex-ui-assets/images/teams/photo-employee1.png" alt="">
                                <p class="text-lg font-medium text-gray-500 line-clamp-2">CEO &amp; Founder CEO &amp;
                                    Founder
                                    CEO
                    ...
                    <div class="flex justify-end">
                        <button type="submit">
                            <div
                                ...
                                <span class="whitespace-nowrap font-semibold text-2xl">Ajouter l'objet</span>
                            </div>
                        </button>
                    </div>
            </form>
