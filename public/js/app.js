...
addPosologieField.addEventListener("click", function () {
  ...
  divParent.classList.add("w-full", "flex", "flex-wrap", "mx-4", "my-6"); // Dosage
  // Create div for dosage field

  var divDosage = document.createElement("div");
  divDosage.classList.add("mr-10"); // Create label for dosage field

  var labelDosage = document.createElement("label");
  labelDosage.classList.add("mr-2");
  labelDosage.setAttribute("for", "dosage");
  labelDosage.innerHTML = "Dosage:"; // create input
  ...
  inputDosage.setAttribute("required", "required"); // append label and input to divDosage

  divDosage.appendChild(labelDosage);
  divDosage.appendChild(inputDosage); // create label for posologie field

  var labelPosologie = document.createElement("label");
  labelPosologie.classList.add("flex", "items-center", "mr-2");
  labelPosologie.setAttribute("for", "posologie");
  labelPosologie.innerHTML = "Heure:"; // create input for posologie field

  var inputPosologie = document.createElement("input");
  ...
  inputPosologie.setAttribute("required", "required"); // Bin icon
  // Create div for bin icon

  var divBin = document.createElement("div");
  divBin.setAttribute("id", "delPosologieField");
  divBin.classList.add("flex", "items-center", "ml-6", "cursor-pointer"); // create image for bin icon

  var imgBin = document.createElement("img");
  imgBin.setAttribute("height", "38");
  imgBin.setAttribute("width", "38");
  imgBin.setAttribute("src", "http://localhost:8000/storage/asset/image/icon/bin.svg");
  imgBin.setAttribute("alt", "bin Icon"); // append image to divBin

  divBin.appendChild(imgBin); // append input and button to div
